    ...
    <>
      ...
      <div className="header-container">
        ...
        <div className="header-parent">
          <NavLink to={reactRouter.user.booking} className={({ isActive }) => `${isActive ? 'nav-text-booking_none' : 'nav-text-booking'}`}>Забронировать</NavLink>
          <NavLink to={reactRouter.user.house} className={({ isActive }) => `${isActive ? 'nav-text-booking_none' : 'nav-text-booking'}`}>Дома</NavLink>

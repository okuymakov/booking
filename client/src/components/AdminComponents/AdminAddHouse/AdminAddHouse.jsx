        ...
        ? (
          <div className="app-container">
            ...
            <form ref={formAddHouse} onSubmit={createHouse}>
              ...
              <div className='text-area-container formItem'>
                <label htmlFor="houseDescription">
                  Описание дома:
                  <textarea type="text" id="houseDescription" name="description" className='text-area'/>
                </label>
              </div>
              ...
              <div className="images_box formItem">
